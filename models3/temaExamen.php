...
class temaExamen {
    ...
    private static $update = 'UPDATE tema_examen SET numTema = ? WHERE numExam = ?';

    private static $insert = 'INSERT INTO tema_examen (numTema, numExam) VALUES (?, ?)';
    ...
    public static function insert() {
        ...
        if (func_num_args() == 2) {
            ...
            $numTema = func_get_arg(0);
            $numExam = func_get_arg(1);

            $command->bind_param('ii', $numTema, $numExam);
    ...
    public static function updateTema($NumTema, $numExam) {
        $connection = connection::get_connection();
