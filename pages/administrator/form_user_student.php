...
<head>
    ...
    <link rel="stylesheet" href="css/form_user_student.css">
...
<body>
    <div class="outer-container">
        <div class="container">
            <h2><i id="icon-student" class="fas fa-user-graduate"></i> Registro de Alumno</h2>
            ...
            <form id="studentForm" action="register_student_user.php" method="POST" enctype="multipart/form-data">
            ...
            <div id="modal" class="modal">
                <div class="modal-content">
                    ...
                    <div class="modal-right">
                        ...
                        <h3>Detalles del Alumno registrado</h3>
                        <ul>
                            <li><strong>Matricula:</strong> <span id="modal-matricula"></span></li>
            ...
            <script>
                ...
                function showSuccessMessage() {
                    ...
                    successMessageElement.textContent = 'Alumno registrado exitosamente';
                ...
                document.getElementById('studentForm').addEventListener('submit', function (e) {
                    ...
                    xhr.open("POST", "register_student_user.php", true);
                    ...
                    xhr.onload = function () {
                        if (xhr.status == 200) {
                            ...
                            if (response.success) {
                                ...
                                document.getElementById('modal-matricula').textContent = response.matricula;
