...
<head>
    ...
    <link rel="stylesheet" href="css/form_user_admin.css">
...
<body>
    <div class="outer-container">
        <div class="container">
            <h2><i id="icon-admin" class="fas fa-user-shield"></i> Registro de Administrador</h2>
            <div id="messages"></div>
            <form action="register_admin_user.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="photo-upload" onclick="document.getElementById('foto').click();">
                    <img id="preview" src="path/to/placeholder.jpg" alt="Foto de usuario"/>
